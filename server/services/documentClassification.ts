...
const COMPATIBLE_PAGE_TYPES: Record<string, ReadonlySet<string>> = {
  ...
  brokerage_statement: new Set(["brokerage_statement"]),
  retirement_statement: new Set(["retirement_statement", "retirement_statement_401k", "retirement_statement_ira"]),
  retirement_statement_401k: new Set(["retirement_statement_401k"]),
  retirement_statement_ira: new Set(["retirement_statement_ira"]),
